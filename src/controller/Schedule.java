...
public class Schedule {
    ...
    private void initialize() throws SQLException {
        ...
        appointmentByMonthRadio.setText(LanguageManager.getLocalString("Appointments_This_Month"));
        appointmentByWeekRadio.setText(LanguageManager.getLocalString("Appointments_This_Week"));
        allAppointmentsRadio.setText(LanguageManager.getLocalString("All_Appointments"));
     ...
     * The predicate is implemented as a lambda expression. Appointments are filtered by comparing their month value to
     * the month value of the system's default date.
     * @return FilteredList generated by passing in appointmentList and a predicate.
     * */
    private FilteredList<Appointment> monthFilter() {
        return new FilteredList<>( appointmentList,
                p -> p.getStart().getMonthValue() == ZonedDateTime.now(ZoneId.systemDefault()).getMonthValue());
    }
    /**
     * Contains Lambda 1
     * Returns a FilteredList of Appointments from the appointmentList ObservableList.
    ...
    /**
     * Used to change viewAll to true when selected.
     * */
    public void onAllAppointmentsRadio() {
        viewAll = true;
        setUpTables();
    }
