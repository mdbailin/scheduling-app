...
public class Schedule {
    ...
    public void setUpTables() {
        ...
        if (monthSort) {
            appointmentTableView.setItems(monthSort());
        }
        else {
            appointmentTableView.setItems(weekSort());
        }
     ...
     * creation of the SortedList. Appointments are compared by their month value.
     * @return SortedList generated by passing in appointmentList and a comparator.
     * */
    private SortedList<Appointment> monthSort() {
        return new SortedList<>( appointmentList,
                Comparator.comparingInt((Appointment appointment) -> appointment.getStart().getMonthValue()));
    }
    /**
     * Contains Lambda 2
     * Returns a SortedList of Appointments from the appointmentList ObservableList.
     * The Comparator is implemented as a lambda expression, so I can utilize its abstract method of compare() in the
     * creation of the SortedList. Appointments are compared by their week of the year.
     * @return SortedList generated by passing in appointmentList and a comparator.
     * */
    private SortedList<Appointment> weekSort() {
        return new SortedList<>( appointmentList,
                Comparator.comparingInt((Appointment appointment) -> appointment.getStart()
